...
str(EPI_dataset)
EPI_subset <- subset(EPI_dataset, select = c(-code, -ISO3V10, -Country, -GEO_subregion, -No_surface_water, -ACSAT_pt_imp, -WATSUP_pt_imp))
EPI_subset <- EPI_subset %>% group_by(EPI_regions)
